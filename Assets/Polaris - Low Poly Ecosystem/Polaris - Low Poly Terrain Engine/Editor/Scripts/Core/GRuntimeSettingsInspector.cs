    ...
    public class GRuntimeSettingsInspector : Editor
    {
        ...
        private void DrawFoliageDefaultSettings()
        {
            ...
            GEditorCommon.Foldout(label, false, id, () =>
            {
                ...
                GRuntimeSettings.Instance.foliageDefault.treeSnapLayerMask = EditorGUILayout.LayerField("Snap Layer", GRuntimeSettings.Instance.foliageDefault.treeSnapLayerMask);
                ...
                GRuntimeSettings.Instance.foliageDefault.grassSnapLayerMask = EditorGUILayout.LayerField("Snap Layer", GRuntimeSettings.Instance.foliageDefault.grassSnapLayerMask);
